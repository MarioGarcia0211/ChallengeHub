  ...
  <div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-md-6 mb-3">
        ...
        <input id="nombres" type="text" class="form-control" :class="{ 'is-invalid': errores.nombres }"
          v-model="form.nombres" @blur="validarCampo('nombres', form.nombres)" @input="limpiarError('nombres')" />
      </div>

      <!-- Apellidos -->
      <div class="col-md-6 mb-3">
        <label for="apellidos" class="form-label">Apellidos</label>
        <input id="apellidos" type="text" class="form-control" :class="{ 'is-invalid': errores.apellidos }"
          v-model="form.apellidos" @blur="validarCampo('apellidos', form.apellidos)"
      ...
      <div class="col-md-6 mb-3">
        ...
        <select id="tipoDocumento" class="form-select" v-model="form.tipoDocumento">
      ...
      <div class="col-md-6 mb-3">
        ...
        <input id="numeroDocumento" type="number" class="form-control"
          :class="{ 'is-invalid': errores.numeroDocumento }" v-model="form.numeroDocumento"
          @blur="validarCampo('numeroDocumento', form.numeroDocumento)" @input="limpiarError('numeroDocumento')" />
      </div>

      <!-- Foto de perfil -->
      <div class="col-md-12 mb-3">
        <label for="fotoPerfil" class="form-label">Foto de perfil</label>
        <input id="fotoPerfil" type="file" class="form-control" @change="handleFoto" />
      </div>
